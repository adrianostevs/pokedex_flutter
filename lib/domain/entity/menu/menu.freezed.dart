...
mixin _$Menu {
  ...
  String get assets => throw _privateConstructorUsedError;
...
abstract class $MenuCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String assets});
}
...
class _$MenuImpl implements _Menu {
  _$MenuImpl({required this.id, required this.title, required this.assets});
  ...
  @override
  String toString() {
    return 'Menu(id: $id, title: $title, assets: $assets)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, assets);
...
abstract class _Menu implements Menu {
  factory _Menu(
      ...
      required final String assets}) = _$MenuImpl;
